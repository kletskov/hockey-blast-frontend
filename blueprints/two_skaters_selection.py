...
def search_skaters(first_name, last_name):
    ...
    query = db.session.query(Human).join(OrgStatsSkater, Human.id == OrgStatsSkater.human_id)
    ...
    for player in results:
        ...
        alias_names = [f"{alias.first_name} {alias.middle_name} {alias.last_name}".strip() 
        ...
        player_name = f"{player.first_name} {player.middle_name} {player.last_name}".strip()
...
def select_skaters():
    ...
    if request.method == 'POST':
        if 'search' in request.form:
            ...
            return redirect(url_for('two_skaters_selection.select_skaters', 
            ...
            return redirect(url_for('skater_to_skater.skater_to_skater',
                                  human_id_1=selected_skater_1,
                                  human_id_2=skater_2_id))
    
    return render_template('two_skaters_selection.html',
                         stage=stage,
